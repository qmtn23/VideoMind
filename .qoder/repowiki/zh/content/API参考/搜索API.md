...
<cite>
**本文档引用的文件**   
- [SearchController.java](file://src/main/java/com/qmtn/videomind/controller/SearchController.java#L21-L89)
- [HybridSearchService.java](file://src/main/java/com/qmtn/videomind/service/HybridSearchService.java#L30-L199)
- [SearchResult.java](file://src/main/java/com/qmtn/videomind/entity/SearchResult.java#L1-L38)
- [EsDocument.java](file://src/main/java/com/qmtn/videomind/entity/EsDocument.java#L1-L47)
...
## 简介
本API文档详细描述了VideoMind知识库系统的混合搜索功能。该系统采用检索增强生成（RAG）技术，结合关键词匹配与向量语义搜索，为用户提供精准的文档检索服务。API通过整合Elasticsearch全文检索与向量数据库的近似最近邻（KNN）搜索，实现了高效的混合检索能力。本文档旨在为开发者提供完整的接口说明、请求/响应示例及后端实现逻辑，以便快速集成和使用搜索功能。
...
**Section sources**
- [SearchController.java](file://src/main/java/com/qmtn/videomind/controller/SearchController.java#L21-L56)
