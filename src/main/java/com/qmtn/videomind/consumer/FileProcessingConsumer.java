package com.qmtn.videomind.consumer;

import com.qmtn.videomind.config.KafkaConfig;
import com.qmtn.videomind.model.FileProcessingTask;
import com.qmtn.videomind.service.ParseService;
import com.qmtn.videomind.service.VectorizationService;
    ...
    private InputStream downloadFileFromStorage(String filePath) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
        ...
        try {
            ...
            if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
                ...
                // 添加必要的请求头
                connection.setRequestProperty("User-Agent", "VideoMind-FileProcessor/1.0");
